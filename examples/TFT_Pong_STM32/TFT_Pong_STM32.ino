...
void initgame() {
  ...
  tft.fillRect(0,h-26,w,239,GRAY);
  //tft.setTextDatum(TC_DATUM);
  tft.setTextColor(WHITE,GRAY);
  _drawString("STM32 example", 05, h-26 , 4);
...
void midline() {
  ...
  tft.drawFastVLine(dashline_x,i,5,WHITE);
  }
...
void lpaddle() {
  ...
  tft.fillRect(lpaddle_x, lpaddle_y, paddle_w, paddle_h, CYAN);
}
...
void rpaddle() {
  ...
  tft.fillRect(rpaddle_x, rpaddle_y, paddle_w, paddle_h, YELLOW);
}
