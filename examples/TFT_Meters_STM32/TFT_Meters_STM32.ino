  ...
  for (int i = -50; i < 51; i += 5) {
    ...
    if (i % 25 == 0) {
      ...
      switch (i / 25) {
        ...
        case 0: _drawString("50", x0-10, y0 - 6, 2); break;
        case 1: _drawString("75", x0-10, y0 - 9, 2); break;
        case 2: _drawString("100", x0-15, y0 - 12, 2); break;
      }
    }
...
void plotLinear(char *label, int x, int y)
{
  ...
  _drawString(label, (x + w / 2) - 10, y + 2, 2);
...
//    _drawString(buf, (i * 40 + 36 - 5) - 50, 187 - 27 + 155 - 18, 2);
    _drawString(buf, (i * 40 + 36 - 5) - 35, y + 137, 2);
